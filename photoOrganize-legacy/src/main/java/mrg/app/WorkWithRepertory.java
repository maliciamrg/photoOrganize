...
public class WorkWithRepertory {
    ...
    public static boolean deleteEmptyRep(File directory, JProgressBar progress) throws IOException {
        TimeTracker.startTimer(Thread.currentThread().getStackTrace()[1].getMethodName() + " -- " + directory, Main.LOGGER_TO_TIME);
        ...
        TimeTracker.endTimer(Thread.currentThread().getStackTrace()[1].getMethodName() + " -- " + directory, Main.LOGGER_TO_TIME);
